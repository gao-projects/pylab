...
macro(itom_init_plugin_common_vars)
    ...
    option(BUILD_OPENMP_ENABLE "Use OpenMP parallelization if available.\
        ...
        OpenMP is generally available and if the build is release." OFF)
    option(BUILD_WITH_PCL "Build itom with PointCloudLibrary support (pointCloud, polygonMesh, point...)" OFF)
...
macro(itom_library_translation qm_files)
    ...
    set(ITOM_LANGUAGES "zh" CACHE STRING "semicolon separated list of languages that should be created (en must not be given since it is the default)")
