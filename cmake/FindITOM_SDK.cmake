...
if(EXISTS ${ITOM_SDK_CONFIG_FILE})
    ...
    message(STATUS "--------------- ITOM_SDK_LIB_COMPONENTS ${ITOM_SDK_LIB_COMPONENTS} -----------------")

    if(${CMAKE_PROJECT_NAME}  MATCHES "PyLab")
        # if CMAKE Module is called from PyLab libraries, variables
    ...
    else(${CMAKE_PROJECT_NAME}  MATCHES "PyLab")
